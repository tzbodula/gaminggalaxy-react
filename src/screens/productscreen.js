...
import LoadingBox from "../react-components/LoadingBox";
...
function ProductScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(`/api/galaxymerch/slug/${slug}`);
  ...
  const addToCartHandler = async() => {
    ...
    const { data } = await axios.get(`/api/galaxymerch/${product._id}`);
